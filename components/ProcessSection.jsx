                    ...
                    {steps.map((step, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-8 h-8 bg-white border border-gray-200 rounded-full items-center justify-center z-10 shadow-sm">
