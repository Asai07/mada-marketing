...
const InfoBento = ({ isMobile }) => {
    ...
    // 1. Lógica para el seguimiento del mouse (Se mantiene igual)
    ...
    // 2. Lógica para animar el contador (Se mantiene igual)
    useEffect(() => {
    ...
    const containerVariants = {
        ...
        visible: {
            opacity: 1,
            transition: { staggerChildren: 0.15 } // Efecto cascada rápido
        }
    };
