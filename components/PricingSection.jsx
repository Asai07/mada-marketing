...
const PricingSection = () => {
    ...
    return (
        <section className="py-20 md:py-32 px-6 overflow-hidden"> {/* overflow-hidden en la sección para evitar scroll lateral accidental */}
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    {/* PLAN 2: MOMENTUM (Destacado) */}
                    <motion.div variants={itemVariants} className="h-full relative z-10">
                        {/* Nota: Mantenemos las clases de transform originales del diseño */}
