        ...
        <main className="min-h-screen bg-black text-white selection:bg-lime-400 selection:text-black font-sans">
                ...
                <div className="max-w-6xl mx-auto text-center relative z-10">
                    <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            <a href={`https://wa.me/${process.env.NEXT_PUBLIC_PHONE_NUMBER}?text=Hola,%20me%20interesa%20una%20estrategia%20de%20marketing.`} target="_blank" className="px-8 py-3 md:px-10 md:py-4 bg-lime-400 text-black font-bold rounded-full hover:scale-105 transition-transform text-base md:text-lg flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(163,230,53,0.3)]">
            ...
            <section className="py-24 md:py-32 px-6 bg-lime-400 text-black text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <a href={`https://wa.me/${process.env.NEXT_PUBLIC_PHONE_NUMBER}?text=Hola,%20me%20interesa%20agendar%20una%20estrategia%20de%20marketing.`} target="_blank" className="inline-flex items-center gap-3 px-10 py-4 md:px-12 md:py-5 bg-black text-white font-bold rounded-full text-base md:text-lg hover:scale-105 transition-transform shadow-2xl">
